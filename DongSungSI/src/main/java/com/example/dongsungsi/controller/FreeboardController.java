...
public class FreeboardController {
    ...
    @Autowired
    private FreeboardServiceImpl freeboardService; // 객체 정의( null => 스프링 객체)
    ...
    createFreeboard(@RequestBody Freeboard freeboard) {
    ...
    public ResponseEntity<Object> getFreeboardByNo(@PathVariable("no") Long no) {
        // id 로 회원 조회하는 서비스를 호출 ( Optional 떼내기 : get() )
        Freeboard freeboard = freeboardService.findByNo(no).get();
